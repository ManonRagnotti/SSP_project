...
/*
* modalUser : When you click on a employee, you will see its more detailed information and its unavailability
*/

export default({data, onToggleModal}) => {

  return (<div className="modalUserContainer">
    <div className="modalUser">
      ...
      <div className="right">
        ...
        <div className="infos">
          ...
          <span className="address">27 Rue du Progrès
            <br></br>93 100 MONTREUIL</span>
        </div>
